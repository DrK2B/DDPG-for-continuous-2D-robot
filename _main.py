...
def DDPG():
    ...
    HPARAMS = {
        ...
        "Critic layer sizes": (64, 64, 64),  # number of hidden layers is variable and corresponds to tuple length
        "Actor layer sizes": (64, 64, 64),  # number of hidden layers is variable and corresponds to tuple length
        "Batch size": 64,
        "Noise type": "Gaussian",
